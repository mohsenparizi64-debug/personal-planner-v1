        ...
        try:
            ...
            for col_name, col_type in new_user_columns:
                if col_name not in columns:
                    ...
                    print(f"✅ Auto-migrated column '{col_name}' added to 'users' table.")
        except Exception as e:
            print(f"User migration note: {e}")

        # ۳. مایگریشن اتوماتیک ستون‌های جدید تسک‌ها (is_infinite_recurrence و auto_reschedule)
        try:
            ...
            if "is_infinite_recurrence" not in t_columns:
                ...
                print("✅ Auto-migrated 'is_infinite_recurrence' added to 'tasks'.")
